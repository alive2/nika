 ...
 *
 * Ported from alive2/nika-code v1.3.0 `nikaPricing.ts` (MIT).
 */
...
/** Convenience check: is this id a Nika DeepSeek model (chat or responses)? */
export function isNikaDeepSeekModelId(id: string): boolean {
